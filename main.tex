...
%
    ...
    \draw[arrow] (tcu) -- (ivi) node[midway, above, font=\sffamily\scriptsize] {Réseau Interne\\(Vulnérable si compromis)};
...
\begin{figure}[H]
    ...
    \draw[arrow] (embed1) -- (vdb) node[midway, left, font=\sffamily\scriptsize] {Stockage des vecteurs};
    ...
    \draw[dashedarrow] (vdb) -- (search) node[midway, above, font=\sffamily\scriptsize] {Top-K contextes};
    ...
    \draw[arrow] (search) -- (llm) node[midway, right, font=\sffamily\scriptsize] {Requête + Contexte};
...
\begin{figure}[H]
    ...
    % Interaction Loops
    \draw[arrow] (input) -- (brain) node[midway, above, font=\sffamily\scriptsize] {Ingestion};
    \draw[arrow] (brain) -- (output) node[midway, above, font=\sffamily\scriptsize] {Décision};

    \draw[->, >=stealth, thick, color=blue!80, bend left=20] (brain) to node[midway, right, font=\sffamily\scriptsize] {Recherche de similarité} (memory);
    \draw[->, >=stealth, thick, color=blue!80, bend left=20] (memory) to node[midway, left, font=\sffamily\scriptsize] {Contexte injecté (RAG)} (brain);

    \draw[->, >=stealth, thick, color=orange!80, bend left=20] (brain) to node[midway, left, font=\sffamily\scriptsize] {Appel d'outil (Action)} (tools);
    \draw[->, >=stealth, thick, color=orange!80, bend left=20] (tools) to node[midway, right, font=\sffamily\scriptsize] {Résultat (Observation)} (brain);
