...
\usetikzlibrary{shadows, shapes.geometric, shapes.clouds, positioning, arrows.meta}
...
%
    ...
    \caption[Organigramme de Capgemini Engineering Maroc]{Organigramme de Capgemini Engineering Maroc.}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        every node/.style={font=\sffamily\small, align=center},
        cloudnode/.style={cloud, draw, cloud puffs=10, cloud puff arc=120, aspect=2, inner ysep=1em, fill=gray!10, drop shadow},
    ...
    % Top Level
    \node[cloudnode] (cloud) at (0, 6) {Serveur Backend OTA\\(Constructeur automobile)};
    ...
    \caption[Architecture OTA]{Architecture OTA.}
    \label{fig:architecture_ota}
\end{figure}

\begin{table}[htbp]
\centering
\caption[Typologie des cybermenaces ciblant les calculateurs d'infodivertissement]{Typologie des cybermenaces ciblant les calculateurs d'infodivertissement.}
...
\begin{table}[htbp]
\centering
\caption[Comparaison des capacités de détection]{Comparaison des capacités de détection.}
...
%
    ...
    \caption[Diagramme de Gantt du projet]{Diagramme de Gantt du projet.}
...
%
    ...
    \caption[Comparaison Black Box (ML) vs Glass Box (LLM)]{Comparaison Black Box (ML) vs Glass Box (LLM).}
...
\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption[Propriétés d'un agent cognitif]{Propriétés fondamentales d'un agent cognitif dans l'architecture Cyber-MAS.}
...
\begin{table}[htbp]
\centering
\caption[Catégorisation des sources de Threat Intelligence]{Catégorisation des sources de Threat Intelligence.}
...
\begin{figure}[H]
    ...
    \caption[Schéma théorique du paradigme RAG]{Schéma théorique du paradigme RAG.}) en cinq \'etapes s\'equentielles, de la requ\^ete initiale jusqu'\`a la g\'en\'eration du verdict augment\'e.}
...
%
    ...
    \caption[Diagramme d'architecture globale du système distribué Cyber-MAS]{Diagramme d'architecture globale du système distribué Cyber-MAS.}
...
%
    ...
    \caption[Diagramme de séquence UML de l\'analyse multi-agents]{Diagramme de séquence UML de l\'analyse multi-agents.} jusqu'\`a la restitution de l'alerte XAI via SSE.}
...
\begin{figure}[H]
    ...
    \caption[Dataflow du cycle cognitif d\'un agent]{Dataflow du cycle cognitif d\'un agent.}
...
%
    ...
    \caption[Cinématique de fonctionnement du RAG]{Cinématique de fonctionnement du RAG.}
...
\begin{table}[htbp]
\centering
\caption[Comparaison des stockages vectoriels]{Comparaison des solutions de stockage vectoriel.}
...
\begin{figure}[H]
    ...
    \caption[Interface principale du Dashboard Cyber-MAS]{Interface principale du Dashboard Cyber-MAS.}
...
\begin{figure}[H]
    ...
    \caption[Vue du pipeline d'exécution multi-agents]{Vue du pipeline d'exécution multi-agents.}
...
\begin{figure}[H]
    ...
    \caption[Matrice MITRE ATT\&CK intégrée]{Matrice MITRE ATT\&CK intégrée au Dashboard.}
...
\begin{figure}[H]
    ...
    \caption[Interface de l'Agent Corrélateur]{Interface de l'Agent Corrélateur.}
...
\begin{figure}[H]
    ...
    \caption[Panneau de gestion des alertes]{Panneau de gestion et de triage des alertes.}
...
\begin{figure}[H]
    ...
    \caption[Statistiques globales de détection]{Tableau de bord des statistiques globales de détection.}
...
\begin{figure}[H]
    ...
    \caption[Interface de Threat Hunting]{Interface de Threat Hunting.}
...
\begin{figure}[H]
    ...
    \caption[Vue détaillée de l'état]{Vue détaillée de l'état.}
...
\begin{figure}[H]
    ...
    \caption[Vue Timeline d'Attaque]{Vue Timeline d'Attaque.}
...
\begin{figure}[H]
    ...
    \caption[Flux de Logs en Direct]{Flux de Logs en Direct.}
...
\begin{figure}[H]
    ...
    \caption[Historique des Analyses]{Historique des Analyses.}
...
\begin{figure}[H]
    ...
    \caption[Diagnostic de Santé du Système]{Diagnostic de Santé du Système.}
...
\begin{figure}[H]
    ...
    \caption[Exécution de Cyber-MAS en mode console]{Exécution de Cyber-MAS en mode console.}
    \label{fig:cli_mode}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption[Extrait d\'un rapport d\'incident PDF]{Extrait d\'un rapport d\'incident PDF.}
...
\begin{table}[htbp]
\centering
\caption[Performances individuelles des agents]{Performances individuelles des agents.}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Graphique des performances individuelles des agents]{Graphique des performances individuelles des agents.}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Comparaison de précision et explicabilité]{Comparaison de précision et explicabilité.}
    \label{fig:kpi_chart}
\end{figure}

\begin{table}[htbp]
\centering
\caption[Comparaison des Indicateurs de Performance]{Comparaison des Indicateurs de Performance.}
...
\begin{table}[htbp]
\centering
\caption[Impact de l'In-Context Learning]{Impact de l'In-Context Learning.}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Impact du RAG sur les faux positifs]{Impact de la boucle d'apprentissage RAG sur les faux positifs.}
...
\textbf{CoT} & Chain of Thought (Chaîne de Pensée) \\
...
\textbf{IVI} & In-Vehicle Infotainment (Infodivertissement) \\
\textbf{JSON} & JavaScript Object Notation \\
\textbf{KPI} & Key Performance Indicator \\
\textbf{LLM} & Large Language Model \\
\textbf{MAS} & Multi-Agent System (Système Multi-Agents) \\
\textbf{MITRE} & Massachusetts Institute of Technology Research and Engineering \\
...
\textbf{TCU} & Telematics Control Unit (Unité Télématique) \\
...
\begin{table}[htbp]
\centering
\caption[Matrice MITRE ATT\&CK embarquée]{Matrice MITRE ATT\&CK appliquée aux systèmes embarqués.}
\vspace{0.2cm}
