...
%
    ...
    \node[gateway] (ivi) at (4.5, -1.5) {Calculateur IVI\\(Infodivertissement)};
    
    \node[bus] (can) at (2.25, -3.5) {Bus Réseau Véhicule Critique (CAN / Automotive Ethernet)};
    ...
    % Grouping borders
    \draw[zone=blue] (-4.5, -0.5) rectangle (7.5, -6) node[above left, opacity=1, font=\sffamily\small\bfseries, color=blue!80] {Architecture Interne du Véhicule (Isolée)};
    \draw[zone=gray] (-4.5, 0.5) rectangle (7.5, 3.5) node[above left, opacity=1, font=\sffamily\small\bfseries, color=gray!80] {Réseau Externe (Vulnérable)};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \addplot coordinates {(Précision, 93.6) (Explicabilité (XAI), 100)};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Impact de la boucle d'apprentissage RAG sur la...]{Impact de la boucle d'apprentissage RAG sur la r\'eduction du Taux de Faux Positifs (FPR) par sc\'enario de test sur banc HIL.}
